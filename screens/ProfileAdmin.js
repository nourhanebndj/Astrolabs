...
const ProfileAdminScreen = ({ navigation }) => {
  ...
  const isRTL = i18n.dir() === "rtl"; // Determine if the language is RTL
  ...
  useEffect(() => {
    const handleRTL = async () => {
      const shouldUseRTL = selectedLanguage === "ar";
      if (I18nManager.isRTL !== shouldUseRTL) {
        await I18nManager.forceRTL(shouldUseRTL);
        RNRestart.Restart(); // Restart the app to apply the RTL changes
      }
    };
    handleRTL();
  }, [selectedLanguage]);
  ...
  // Handle language change and apply it
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        <Text
          style={[styles.detail, { textAlign: isRTL ? "right" : "left" }]}
        >
