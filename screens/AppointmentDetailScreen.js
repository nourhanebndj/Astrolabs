...
const AppointmentDetailScreen = ({ route }) => {
      ...
      <View style={styles.card}>
        {requestDetails.firstname && requestDetails.lastname && (
          <View style={[styles.infoRow,
            ...
            {t('person')} 1: {requestDetails.firstname} {requestDetails.lastname}
          </Text>
          </View>
        )}
        ...
        {requestDetails.firstName1 && requestDetails.lastName1 && (
          <View style={[styles.infoRow,
            ...
            <FontAwesome name="user" size={20} color="#333" />
            <Text style={styles.infoText}>
              {t('person')} 1: {requestDetails.firstName1} {requestDetails.lastName1}
            </Text>
  ...
  {requestDetails.birth1birthMonth}/{requestDetails.birth1birthYear}
</Text>
...
<View style={[styles.infoRow,
  ...
  {requestDetails.birth1birthMinute}:{requestDetails.birth1birthSecond}
</Text>
...
<View style={[styles.infoRow,
            { flexDirection: isRTL ? "row-reverse" : "row" },
              ...
              <FontAwesome name="birthday-cake" size={20} color="#333" />
              <Text style={styles.infoText}>
                  {t('birthDatePerson1')}: {requestDetails.birthbirthDay}/{requestDetails.birthbirthMonth}/{requestDetails.birthbirthYear}
                </Text>
        ...
        {requestDetails.firstName2 && requestDetails.lastName2 && (
          <View style={[styles.infoRow,
            { flexDirection: isRTL ? "row-reverse" : "row" },
                      ...
                      <FontAwesome name="user" size={20} color="#333" />
                      <Text style={styles.infoText}>
  {t('person2')}: {requestDetails.firstName2} {requestDetails.lastName2}
</Text>
...
<View style={[styles.infoRow,
  ...
  {requestDetails.birth2birthMonth}/{requestDetails.birth2birthYear}
</Text>
...
<View style={[styles.infoRow,
            ...
            <Text style={styles.infoText}>
                ...
                {requestDetails.birth2birthMinute}:{requestDetails.birth2birthSecond}
              </Text>
...
{requestDetails.selectedAdditionalOptions && requestDetails.selectedAdditionalOptions.length > 0 && (
  <View style={[styles.infoRow,
            { flexDirection: isRTL ? "row-reverse" : "row" },
          ]}>  
              <FontAwesome name="flask" size={20} color="#333" />
              <Text style={styles.infoText}>
  {t('supplementServices')}: {requestDetails.selectedAdditionalOptions.join(", ")}
</Text>
        ...
        {requestDetails.selectedCompatibilityType && (
          <View style={[styles.infoRow,
            { flexDirection: isRTL ? "row-reverse" : "row" },
                      ...
                      <Text style={styles.infoText}>
  {t('typeOfCompatibility')}: {requestDetails.selectedCompatibilityType}
</Text>
