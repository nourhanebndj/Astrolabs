...
const DateTimePickerAnalysis = ({ onChange, initialValues }) => {
      ...
      {Platform.OS === "ios" ? (
        ...
        >
          ...
          <RNPickerSelect
            ...
            items={generateItems(currentYear - 100, currentYear)}
          />
          <RNPickerSelect
            style={pickerSelectStyles}
            placeholder={{
        ...
        <>
          ...
          >
            ...
            >
              ...
              {generateItems(currentYear - 100, currentYear).map((item) => (
                <Picker.Item
                  key={item.value}
                  label={item.label}
                  value={item.value}
...
export default DateTimePickerAnalysis;
